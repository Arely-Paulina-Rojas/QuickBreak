...
import 'package:quickbreak/screens/ReminderCreate/components/background.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedInputGenericField(
              ...
              onChanged: (value) {},
              controller: timeBreakTextController,
            ),
            RoundedInputGenericField(
              hintText: "Activity",
            ...
            RoundedButton(
              text: "Save",
              press: () async {
                if(!nameTextController.text.isEmpty && !timeTextController.text.isEmpty && !timeBreakTextController.text.isEmpty && !activityTextController.text.isEmpty){
                  ...
                  if(timeValid && breakValid){
                    ...
                    if(_isBiometricAvaible) {
                      bool didAuthenticate = await _localAuth.authenticate(
                        ...
                        if(didAuthenticate){
                          success =  await APIService.saveReminder(reminderModel!, false);
                        }else{
                    ...
                    if(success){
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: CustomSnackBarContent(titleText: "Success!", errorText: "Added Reminder!", colorBar: kPrimaryColor, image: "dog.png",),
                        behavior: SnackBarBehavior.floating,
                        backgroundColor: Colors.transparent,
                        elevation: 0,
                      ));
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: CustomSnackBarContent(titleText: "Oh snap!", errorText: "Error adding reminder!", colorBar: kSecondaryColor, image: "death.png",),
                        behavior: SnackBarBehavior.floating,
                        backgroundColor: Colors.transparent,
                        elevation: 0,
                      ));
