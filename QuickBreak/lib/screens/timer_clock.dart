...
class _TimerClockState extends State<TimerClock>{
  ...
  static int screenTime = TimeInMinut;
      ...
      if(mounted){
        setState(() {
          if(Time > 0){
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: CustomSnackBarContent(titleText: "Break time!", errorText: "You should rest!", colorBar: kPrimaryColor, image: "dog.png",),
